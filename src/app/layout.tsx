...
export const metadata: Metadata = {
  ...
  description: "What to actually do when documentation says 'benefits from visual supports' or 'needs tasks broken into steps'. 16 evidence-based strategies with exact scripts, worked examples, and 5-minute prep plans for KS3/KS4 teachers supporting pupils working significantly below age-related expectations.",
